...
Parent synthesis: `docs/dogfood/sanhua-robot-operating-economics-challenger-2026-09-03.md`  
Prepared against main: `9fb517c9592d4c5969907bdb7b7219f78097cdb5`  
Investment Authority: **NONE**

## Current proof table

The headline state remains a sell-side reference:
...
| --- | --- | --- | --- | --- |
| Downstream scale reaches ~1m realized annual robots | `NOT ESTABLISHED` | downstream 1m/year planned-capacity references exist | realized annual output / sell-through / deployment | planned capacity is not realized volume |
...
| 70% is durable mass-production allocation | `ASSUMPTION` | same sell-side work uses ~70% headline share | customer allocation / second source / robot-generation persistence | same work also discusses share falling toward ~50% |
...
- Tuopu realized early robot-actuator GM around 28%, but very small revenue and volatile ramp cost;
