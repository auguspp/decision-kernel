# Sanhua Robot Commercialization + Capital Sequence — 2026-09-03

Status: **RESEARCH CHALLENGER SUPPORT / CASE-SPECIFIC / CAPITAL-SEQUENCE PASS / NO CARDINAL SUCCESS PROBABILITY**  
...
R&D equipment = CNY51.80m
project development + other R&D = CNY142.65m
total = CNY201.80m
```
...
```text
COMMERCIALIZATION = REAL / PROGRESSED
MATURE MASS-PRODUCTION ECONOMICS = NOT ESTABLISHED
```
