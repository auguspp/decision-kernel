...
"""Decision OS Research Method v1 orchestration.

This module is replaceable research policy, not Kernel Constitution. It owns the current
Discovery -> Pre-Research -> Quick Research -> Deep Research workflow and may evolve or be
replaced without changing the method-agnostic Decision Spine in ``workflow.py``.
"""
...
from .odds import OddsContext, OddsResearchPolicy
...
def run_research_funnel(
    *,
    ...
    """Route Research Method v1 cognitive budget without performing sensing or execution."""
...
def run_deepened_decision_path(
    *,
    ...
    """Compose Research Method v1 output into the method-agnostic Decision Spine."""
