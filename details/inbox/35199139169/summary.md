...
生成时间：2026-09-17T08:20:38.345112+00:00
...
**当前状态：** Research 已存在 · `ACCEPTABLE_ODDS` · ¥1266.98 · 行情 2026-09-17T15:00:00+08:00
...
- **三花智控 002050** — ¥34.64 — `INSUFFICIENT_ODDS` — 重新值得看：`ACCEPTABLE_ODDS ≤ ¥29.56`
<details>
<summary>为什么安静</summary>

- 当前：期望收益 `8.4%` · 正收益概率 `60%`
- `ACCEPTABLE_ODDS` 要求：期望收益 ≥ `27%` · 正收益概率 ≥ `55%`
- 重新值得看：`ACCEPTABLE_ODDS ≤ ¥29.56`（距当前价约 `-14.7%`）
...
- **中国神华 601088** — ¥46.48 — `INSUFFICIENT_ODDS` — 重新值得看：`ACCEPTABLE_ODDS ≤ ¥35.37`
<details>
<summary>为什么安静</summary>

- 当前：期望收益 `-3.3%` · 正收益概率 `25%`
- `ACCEPTABLE_ODDS` 要求：期望收益 ≥ `27%` · 正收益概率 ≥ `55%`
- 重新值得看：`ACCEPTABLE_ODDS ≤ ¥35.37`（距当前价约 `-23.9%`）
- Frozen scenarios：base 50% → ¥44.80 · downside 25% → ¥31.20 · upside 25% → ¥58.90

</details>
- **兆易创新 603986** — ¥369.88 — `INSUFFICIENT_ODDS` — 重新值得看：`ACCEPTABLE_ODDS ≤ ¥330.69`
<details>
<summary>为什么安静</summary>

- 当前：期望收益 `18%` · 正收益概率 `70%`
- `ACCEPTABLE_ODDS` 要求：期望收益 ≥ `32%` · 正收益概率 ≥ `55%`
- 重新值得看：`ACCEPTABLE_ODDS ≤ ¥330.69`（距当前价约 `-10.6%`）
