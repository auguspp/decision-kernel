...
生成时间：2026-09-11T12:50:47.363419+00:00
...
**当前状态：** Research 已存在 · `ACCEPTABLE_ODDS` · ¥1275.16 · 行情 2026-09-11T15:00:00+08:00
...
- **三花智控 002050** — ¥34.87 — `INSUFFICIENT_ODDS` — 重新值得看：`ACCEPTABLE_ODDS ≤ ¥29.56`
<details>
<summary>为什么安静</summary>

- 当前：期望收益 `7.7%` · 正收益概率 `60%`
- `ACCEPTABLE_ODDS` 要求：期望收益 ≥ `27%` · 正收益概率 ≥ `55%`
- 重新值得看：`ACCEPTABLE_ODDS ≤ ¥29.56`（距当前价约 `-15.2%`）
...
- **中国神华 601088** — ¥47.51 — `INSUFFICIENT_ODDS` — 重新值得看：`ACCEPTABLE_ODDS ≤ ¥35.37`
<details>
<summary>为什么安静</summary>

- 当前：期望收益 `-5.4%` · 正收益概率 `25%`
- `ACCEPTABLE_ODDS` 要求：期望收益 ≥ `27%` · 正收益概率 ≥ `55%`
- 重新值得看：`ACCEPTABLE_ODDS ≤ ¥35.37`（距当前价约 `-25.5%`）
- Frozen scenarios：base 50% → ¥44.80 · downside 25% → ¥31.20 · upside 25% → ¥58.90

</details>
- **兆易创新 603986** — ¥371.32 — `INSUFFICIENT_ODDS` — 重新值得看：`ACCEPTABLE_ODDS ≤ ¥330.69`
<details>
<summary>为什么安静</summary>

- 当前：期望收益 `17.6%` · 正收益概率 `70%`
- `ACCEPTABLE_ODDS` 要求：期望收益 ≥ `32%` · 正收益概率 ≥ `55%`
- 重新值得看：`ACCEPTABLE_ODDS ≤ ¥330.69`（距当前价约 `-10.9%`）
