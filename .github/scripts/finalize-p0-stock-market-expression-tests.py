...
replace_once(
    "src/decision_kernel/runtime/stock_market_expression.py",
...
Path("tests/test_stock_market_expression.py").write_text(r'''from __future__ import annotations
...
print("focused market-expression tests staged")
