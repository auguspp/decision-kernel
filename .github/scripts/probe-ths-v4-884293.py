#!/usr/bin/env python3
"""One-request same-source THS plain-HTTP v4 qualification for 884293.TI."""
import hashlib
import json
import sys
...
URL = "http://d.10jqka.com.cn/v4/line/bk_884293/01/2026.js"
...
(OUT / "884293.js").write_bytes(body)
result = {
    "schema_version": 1,
